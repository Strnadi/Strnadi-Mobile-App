...
class FileMapDataCacheStore implements MapDataCacheStore {
  ...
  Future<File> _file(String key) async {
    ...
    final Directory cacheDirectory = Directory(
      '${supportDirectory.path}/map-data-cache',
    );
...
class MapDataCache {
  ...
  Future<MapDataCacheEntry?> load() async {
    try {
      ...
      return MapDataCacheEntry(
        savedAt: savedAt,
        recordingsPayload: List<dynamic>.from(
          decoded['recordings'] as List<dynamic>,
        ),
        filteredPartsPayload: List<dynamic>.from(
          decoded['filteredParts'] as List<dynamic>,
        ),
      );
    } catch (_) {
      return null;
  ...
  Future<bool> save(
    ...
    try {
      final List<dynamic> safeRecordings = sanitizeMapRecordingsPayload(
        recordingsPayload,
      );
      final List<dynamic> safeFilteredParts = sanitizeMapFilteredPartsPayload(
