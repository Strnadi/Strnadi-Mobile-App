...
class _RecordingItemState extends State<RecordingItem> {
  ...
  Future<void> _downloadRecording() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text(t("Error downloading recording"))),
      );
    }
  }
  ...
  Future<void> _deleteRecording() async {
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text(t('Error deleting recording'))),
        );
      }
    }
  }
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [Container(
                          ...
                          child: Column(
                            children: [
                              const Row(mainAxisAlignment: MainAxisAlignment.center, children: [Text(t("Datum a čas"))]),
                              Text(
