...
class _RegMailState extends State<RegMail> {
  ...
  Future<void> _validateEmailAvailability(String value) async {
    ...
    setState(() {
      _emailErrorMessage = emailExists
          ? t('signup.mail.errors.mail_exists')
          : null;
    });
  }
                          ...
                          Expanded(
                            child: RichText(
                              text: TextSpan(
                                ...
                                children: [
                                  TextSpan(text: t('signup.mail.consent.con1')),
                                  TextSpan(
                        ...
                        onPressed: !_isLoading
                            ? () {
                                _withLoader(() async {
                                  ...
                                  try {
                                    final bool emailExists = await _checkEmail(
                                      email,
                                    );
                                    if (!mounted) return;
                                    setState(() {
                        ...
                        onPressed: !_isLoading
                            ? () {
                                ...
                                _withLoader(() async {
                                  ...
                                  try {
                                    final data = await apple
                                        .AppleAuth.signInAndGetJwt(null);
                                    if (data == null) {
                                      logger.w(
