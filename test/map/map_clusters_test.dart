...
void main() {
  test('serializes clustering, ownership and dates without removed parameters',
      () {
  ...
  test(
      ...
      () {
    final r = MapClustersResponse.fromResponseData(jsonEncode(responseJson()));
  ...
  test('summarizes structured API errors without logging their full payload',
      () {
